    ...
    <body>
        <jsp:include page="./includes/header.jsp"></jsp:include>
            ...
            <div class="create-area">
                <div class="container">
                    <form action="UpdateEventController" method="POST" enctype='multipart/form-data' accept-charset="utf-8" id="form">
                        <div class="pb-3">
                            <h1 class="text-center font-weight-bold">UPDATE EVENT</h1>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ul>
                                    <li>
                                        <div class="text-field">
                                            <input autocomplete="off" type="text" id="name" name="eventName" value="${event.eventName}"/>
                                    ...
                                    <li>
                                        <div class="text-field">
                                            <input autocomplete="off" type="number" id="slot" name="slot" value="${event.slot}"/>
                                    ...
                                    <li>
                                        <div class="text-field">
                                            <input autocomplete="off" type="number" id="fee" name="ticketFee" value="${event.ticketFee}"/>
                                            ...
                                            <select class="form-control" id="location" name="locationID">
                                                ...
                                                <c:forEach var="location" items="${locationList}">
                                                    <option value="${location.locationID}"
                                                            ...
                                                            >
                                                        ${location.locationName} (Max slot: ${location.locationCapacity})
                                                    </option>
                                                </c:forEach>
                                            </select>
                                            ...
                                            <select class="form-control" id="category" name="categoryID">
                                                ...
                                                <c:forEach var="category" items="${categoryList}">
                                                    <option value="${category.categoryID}"
                                                            <c:if test="${category.categoryID eq event.categoryID}">
                                                                selected
                                                            </c:if>>
